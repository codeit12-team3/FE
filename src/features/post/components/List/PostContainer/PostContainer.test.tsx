...
import { AgeType, GenderType, PostFilterParams } from '@/features/post/types'

import PostContainer from './PostContainer'

jest.mock('@/features/post/hooks/useInfinitePosts')

jest.mock('@/features/post/api/posts.mutations', () => ({
  useAddBookmark: () => ({
    mutateAsync: jest.fn(),
  }),
  useRemoveBookmark: () => ({
...
const { useInfinitePosts } = jest.requireMock(
  '@/features/post/hooks/useInfinitePosts',
)
