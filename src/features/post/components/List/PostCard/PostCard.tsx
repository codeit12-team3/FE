...
import { PostListItem } from '@/features/post/types'
...
import PostCardActions from './CardActions/PostCardActions'
import PostCardImage from './CardImage/PostCardImage'
import PostCardInfo from './CardInfo/PostCardInfo'
