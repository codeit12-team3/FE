...
import { AgeType, GenderType, PostFilterParams } from '@/features/posts/types'

import PostContainer from '.'

jest.mock('@/features/posts/hooks/useInfinitePosts')

jest.mock('@/features/posts/api/posts.mutations', () => ({
  useAddBookmark: () => ({
    mutateAsync: jest.fn(),
  }),
  useRemoveBookmark: () => ({
...
const { useInfinitePosts } = jest.requireMock(
  '@/features/posts/hooks/useInfinitePosts',
)
