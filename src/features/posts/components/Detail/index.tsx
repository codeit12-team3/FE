...
import { useApply, useCompanionId } from '@/features/posts/hooks'
import { GenderType, PostContent } from '@/features/posts/types'
          ...
          <div className="flex gap-6 items-start justify-center">
            <div className="w-full max-w-7xl rounded-lg ">
              ...
              <div className="md:pb-0 pb-16">
                <CommentContainer commentCount={post.commentCount} />
              </div>
            </div>
          </div>
          {post.isOwner === false && (
