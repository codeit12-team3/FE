...
const buttonVariants = cva(
  "inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap font-semibold transition-all disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-blue-500 focus-visible:ring-blue-300 focus-visible:ring-[3px] aria-invalid:ring-red aria-invalid:border-red",
  {
    variants: {
      variant: {
        default: [
        ...
        ghost: [
          ...
          'active:bg-blue-300 text-gray-600',
        ],
        link: [
      ...
      size: {
        'md': 'h-10 rounded-xl px-6 py-2 text-sm has-[>svg]:px-3',
